...
class EndToEndIntegrationSpec extends Specification {
    ...
    def "test that when the scheduler is invoked for a date with timeline events that should include mentions, the events are published to Twitter with the mentions included"() {
        ...
        then:
            ...
            twitter.tweets[4] == "... @liamGallagher @noelgallagher @ThisisDavina #Oasis #OTD #TodayInMusic #britpop"
            ...
            twitter.tweets[7] == '... 2005.\n\n@drummerwhitey @liamGallagher @noelgallagher #Oasis #OTD #TodayInMusic #britpop'
        cleanup:
            dateUtils.reset()
            twitter.reset()
    }
